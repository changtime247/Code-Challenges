...
// ----------------------
// parameters: given a string, filter out all numbers
// return modified string without the numbers
// Examples
// (""), "")
// ("! !"), "! !")
// ("123456789"), "")
...
// pseudocode: split string. map array to only include non numbers. join array. return string.

function stringClean(s){
    return s.split('').map(x=>'0123456789'.includes(x)?'':x).join('');
}