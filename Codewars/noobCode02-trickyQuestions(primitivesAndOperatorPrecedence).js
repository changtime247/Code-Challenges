...
// ----------------------
// parameters: three arbitrary values given
// return a boolean value by comparing (using greater than or less than) the three arguments
// examples:
...
// greaterThanLessThan(3, 2 1)                              -->     true
// graterThanLessThan(-3, -2, -1)                           -->     false
// pseudocode: the above examples show that comparing the first two values and then comparing the result with the third value will produce result needed
